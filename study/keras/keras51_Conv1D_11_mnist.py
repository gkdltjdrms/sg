...
from tensorflow.keras.layers import Conv2D,Conv1D, Dense,LSTM, Flatten, MaxPooling2D, Dropout, Input
import datetime 
...
# 2. 모델 구성  #784
model = Sequential()
model.add(Conv1D(16, 2, input_shape = (784, 1), activation='relu'))
...
model.compile(loss='sparse_categorical_crossentropy', optimizer='adam', 
              metrics=['acc'])
model.fit(x_train, y_train, epochs=1, verbose=1, batch_size=1024,
