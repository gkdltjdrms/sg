...
es = EarlyStopping(monitor='val_loss', patience=75, mode='min',
...
model.fit([samsung_x_train, amore_x_train], samsung_y_train , epochs=1500, batch_size=128, validation_split=0.2, callbacks=[es, mcp])
