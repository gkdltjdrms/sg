...
<tr>
    <th>아이디</th>
    <td><input type="text" name="id" id="id" value="<%=login_id %>" readonly></td>
    <div id="idDiv"></div>
</tr>
...
<tr>
			...
			<input type="button" value="회원정보수정" onclick="location.href='http://localhost:8080/memberJSP/member/update.jsp';"> 
