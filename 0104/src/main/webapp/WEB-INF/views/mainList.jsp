...
<script>
    $(document).ready(function() {
    	  ...
    	  var searchOptions = "${param['search-options']}";
          var searchKeyword = "${param['search-keyword']}";
          var startDate = "${param['start-date']}";
          var endDate = "${param['end-date']}";

          $("#search-options").val(searchOptions);
