...
<body>
	...
	<button type="submit" id="approvalButton" name="action" value="approval"
        style="${(board.payOption eq 'save' or (board.payOption eq 'reject' and board.id eq user.id)) 
                || (board.payOption eq 'wait' && (loggedInUserRank eq '과장' || loggedInUserRank eq '부장'))
                || (board.payOption eq 'checking' && loggedInUserRank eq '부장')
                || (board.payOption eq 'wait' && delegateInfo != null && (delegateInfo.delegateApproverRank eq '과장' || delegateInfo.delegateApproverRank eq '부장')) ? 'display: inline-block;' : 'display: none;'}">결재</button>
	
	<button type="submit" id="rejectButton" name="action" value="reject"
        style="${(board.payOption eq 'wait' && loggedInUserRank eq '과장') 
                || (board.payOption eq 'checking' && loggedInUserRank eq '부장')
                || (board.payOption eq 'wait' && delegateInfo != null && (delegateInfo.delegateApproverRank eq '과장' || delegateInfo.delegateApproverRank eq '부장')) ? 'display: inline-block;' : 'display: none;'}">반려</button>
